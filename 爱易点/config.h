...
#define USE_BAIDU_MAP                   YES

//Ping++
#define PING_PAYMENT_OPTION @"支付宝支付", @"微信支付" /*@"银联支付",*/
#define PING_URL_SCHEME     @"unipingpay"

//APP KEY
#define BAIDU_MAP_KEY       @"没有"
#define WEIXIN_APPID        @"wx5f93226e52af57ca"

#define APP_ID              @"933846850" //itunes store ID

#define SUPPORT_EMAIL       @"support@unicorechina.com"
...
#define PRODUCTION_2_SERVER_ADDRESS             @"https://123.57.135.129"
#define PRODUCTION_1_SERVER_ADDRESS             @"https://182.92.130.225"
#define PRODUCTION_1_SERVER_ADDRESS_NOT_SECURE  @"http://www.unicorechina.com"

#define SERVER_ADDRESS use_production_server ? PRODUCTION_1_SERVER_ADDRESS : TEST_SERVER_ADDRESS
