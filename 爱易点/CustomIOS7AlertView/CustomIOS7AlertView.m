...
@synthesize disableFirstButton;
@synthesize disableSecondButton;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i = [buttonTitles count] - 1; i >= 0; i--) {

        UIButton *closeButton = [UIButton buttonWithType:UIButtonTypeSystem];

        //[closeButton setFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - buttonHeight, buttonWidth, buttonHeight)];
        [closeButton setFrame:CGRectMake(0, container.bounds.size.height - buttonHeight * ([buttonTitles count] - i), buttonWidth, buttonHeight)];
        ...
        if (i == 0 && disableFirstButton) {
            [closeButton setEnabled:NO];
        }
        
        if (i == 1 && disableSecondButton) {
            [closeButton setEnabled:NO];
        }

        [container addSubview:closeButton];
        
        // There is a line above every button
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, container.bounds.size.height - buttonHeight * ([buttonTitles count] - i) - buttonSpacerHeight, container.bounds.size.width, buttonSpacerHeight)];
...
- (CGSize)countDialogSize
{
    ...
    if (buttonTitles == nil || buttonTitles.count == 0)
        ...
        dialogHeight = containerView.frame.size.height + buttonHeight * buttonTitles.count + buttonSpacerHeight;
