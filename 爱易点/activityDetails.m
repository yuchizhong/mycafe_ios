...
- (void)shareActivity {
    ...
    NSString *url = [NSString stringWithFormat:@"%@/images/store%@/activities/activity%@/index.html", PRODUCTION_1_SERVER_ADDRESS_NOT_SECURE, [self.activityInfo objectForKey:@"storeID"], [self.activityInfo objectForKey:@"activity_id"]];
