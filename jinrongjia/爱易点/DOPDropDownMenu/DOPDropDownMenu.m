...
- (UIColor *)indicatorColor {
    if (!_indicatorColor) {
        _indicatorColor = [UIColor whiteColor]; // [UIColor blackColor]; //color
    }
...
- (UIColor *)textColor {
    if (!_textColor) {
        _textColor = [UIColor whiteColor]; //[UIColor blackColor]; //color
    }
    return _textColor;
}
...
- (UIColor *)separatorColor {
    if (!_separatorColor) {
        _separatorColor = [UIColor whiteColor]; //[UIColor blackColor]; //color
    }
...
//    CGFloat separatorLineInterval = self.frame.size.width / _numOfMenu;
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        ...
        CALayer *bgLayer = [self createBgLayerWithColor:COFFEE_DARKEST /*[UIColor whiteColor]*/ /*color*/ andPosition:bgLayerPosition];
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        self.backgroundColor = COFFEE_DARKEST; //[UIColor whiteColor]; //color
        ...
        _backGroundView.backgroundColor = COFFEE_DARKEST; //color
        UIGestureRecognizer *gesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(backgroundTapped:)];
        [_backGroundView addGestureRecognizer:gesture];
        
        //add bottom shadow, ignore
        /*
        UIView *bottomShadow = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-1, screenSize.width, 1)];
        bottomShadow.backgroundColor = COFFEE_GRAY; //[UIColor lightGrayColor]; //color
...
- (void)menuTapped:(UITapGestureRecognizer *)paramSender {
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        if (i != tapIndex) {
            ...
            [(CALayer *)self.bgLayers[i] setBackgroundColor:COFFEE_DARKEST/*[UIColor whiteColor]*//*color*/.CGColor];
        }
    }
    ...
    if (tapIndex == _currentSelectedMenudIndex && _show) {
        ...
        [(CALayer *)self.bgLayers[tapIndex] setBackgroundColor:COFFEE_DARKEST/*[UIColor whiteColor]*//*color*/.CGColor];
    } else {
        _currentSelectedMenudIndex = tapIndex;
        ...
        [(CALayer *)self.bgLayers[tapIndex] setBackgroundColor:COFFEE_GRAY/*[UIColor colorWithWhite:0.9 alpha:1.0]*//*color*/.CGColor];
    }
}
...
- (void)backgroundTapped:(UITapGestureRecognizer *)paramSender
{
    ...
    [(CALayer *)self.bgLayers[_currentSelectedMenudIndex] setBackgroundColor:COFFEE_DARKEST/*[UIColor whiteColor]*//*color*/.CGColor];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.backgroundColor = COFFEE_DARKEST; // [UIColor whiteColor]; //color
    cell.textLabel.font = [UIFont systemFontOfSize:14.0];
    cell.textLabel.textColor = [UIColor whiteColor];
    
    if (cell.textLabel.text == [(CATextLayer *)[_titles objectAtIndex:_currentSelectedMenudIndex] string]) {
        cell.backgroundColor = COFFEE_GRAY; // [UIColor colorWithWhite:0.9 alpha:1.0]; //color
    }
